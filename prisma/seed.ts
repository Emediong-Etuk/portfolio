...
const GITHUB_USERNAME = "Emediong-Etuk";
...
async function main() {
  ...
  await prisma.skill.createMany({
    data: [
      // Technical
      { name: "PHP & Laravel", category: "TECHNICAL", order: 0 },
      { name: "TypeScript & Next.js/React", category: "TECHNICAL", order: 1 },
      { name: "MySQL & PostgreSQL", category: "TECHNICAL", order: 2 },
      { name: "REST API Design", category: "TECHNICAL", order: 3 },
      { name: "Prisma & Eloquent ORM", category: "TECHNICAL", order: 4 },
      { name: "Tailwind CSS", category: "TECHNICAL", order: 5 },
      { name: "Git & GitHub", category: "TECHNICAL", order: 6 },
      // Soft skills
      { name: "Problem-Solving", category: "SOFT", order: 0 },
      { name: "Attention to Detail", category: "SOFT", order: 1 },
      { name: "Clear Technical Communication", category: "SOFT", order: 2 },
      { name: "Self-Directed Learning", category: "SOFT", order: 3 },
      { name: "Ownership & Follow-Through", category: "SOFT", order: 4 },
      { name: "Collaboration & Code Review", category: "SOFT", order: 5 },
      { name: "Adaptability Across Stacks", category: "SOFT", order: 6 },
      { name: "Time Management", category: "SOFT", order: 7 },
    ],
  });
  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        name: "ShowingKit",
        summary:
          "Turns a 15-20 minute apartment walkthrough into a same-day Walk / Negotiate / Offer brief.",
        description:
      ...
      },
      {
        ...
        techStack: ["Laravel", "PHP", "MySQL"],
        highlights: [
          "Custom token-based email verification flow",
          "Movie/User relational data model",
        ],
